...
class WelcomeView: UIView {
    ...
    private func setupConstraints(){
        NSLayoutConstraint.activate([
            ...
            tipsStackView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -24), //Sempre que a constante for pra baixo e pra direita, ela é negativa
    ...
    private func setupTips(){
        ...
        // Formas de declarar uma image, pois a IMAGE coloca um valor opcional.
        ...
        // Não recomendado, pois caso essa imagem não exista... O App irá crashar
        //let tip3 = TipsView(icon: UIImage(named: "ticket")!, title: "Garanta vantagens perto de você", description: "Ative cupons de onde estiver, em diferentes tipos de estabelecimento")
        
        let tip3 = TipsView(icon: UIImage(named: "ticket") ?? UIImage(), title: "Garanta vantagens perto de você", description: "Ative cupons de onde estiver, em diferentes tipos de estabelecimento")
